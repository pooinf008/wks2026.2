...
public class FuncionarioDB{
	...
	private void init() {
		Funcionario f1 = new Funcionario("Ana Silva", "1", "Rua A", "Centro", "40000-000", "Salvador", "BA", Cargo.JUNIOR, new Moeda("R$", 75.00));
		Funcionario f2 = new Funcionario("Bruno Souza", "2", "Rua B", "Pituba", "41000-000", "Salvador", "BA", Cargo.PLENO, new Moeda("R$", 62.00));
		Funcionario f3 = new Funcionario("Carla Dias", "3", "Rua C", "Buraquinho", "42700-000", "Lauro de Freitas", "BA", Cargo.MENTOR, new Moeda("R$", 120.00));
		Funcionario f4 = new Funcionario("Daniel Costa", "4", "Rua D", "Rio Vermelho", "41940-000", "Salvador", "BA", Cargo.SENIOR, new Moeda("R$", 94.00));
		Funcionario f5 = new Funcionario("Elisa Mota", "5", "Rua E", "Vilas do Atlântico", "42700-000", "Lauro de Freitas", "BA", Cargo.TRAINEE, new Moeda("R$", 81.00));
